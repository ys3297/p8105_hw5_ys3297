...
selected more completely and the mean of sample means could approximate
...
and only those which were comparatively farther from the null were
selected. Thus, the mean of sample means overestimated the corresponding
true mean.  
...
Therefore, even though the sample means were comparatively far away from
0, the mean of sample means still eventually approximates 0.
